...
const checkHandler = () => {
  ...
  if (inputValue.value == correctNumber) {
    paigham.innerHTML = "Victory";
    body.style.backgroundColor = "green";
    score.innerHTML = +score.innerHTML + 1;
    highScore.innerHTML = score.innerHTML;
    questionMark.innerHTML = correctNumber;
    confetti()
  } else if (inputValue.value < correctNumber) {
    paigham.innerHTML = "You lost, oops very low";
    ...
    paigham.innerHTML = "You lost, oops very high";
    body.style.backgroundColor = "red";
    score.innerHTML = +score.innerHTML - 1;
    setTimeout(() => {
      body.style.backgroundColor = "black";
...
const gameRestart = () => {
  ...
  correctNumber = randomNumberGenerator();
  const inputValue = document.querySelector("#userAnswer");
  inputValue.value = ''
};
